...
def write_js(path: Path, icons: list[dict]) -> None:
    lines = [
        ...
        "window.ICON_REPLICA_LIBRARY = Object.assign(window.ICON_REPLICA_LIBRARY || {}, {",
    ]
    for item in icons:
        lines.append(
...
def replicate(args: argparse.Namespace) -> None:
    ...
    write_js(out / args.js_file, generated_icons)
    summary = {
...
def main() -> None:
    ...
    parser.add_argument("--js-file", default="icon-replicas-board-01.js", help="Generated JS filename.")
